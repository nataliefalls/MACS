...
static const uint8_t HUB_I2C_ADDRESS = 0x77;
static const uint I2C_BAUDRATE = 100000; // 100 kHz

static const uint I2C_SDA_PIN = PICO_DEFAULT_I2C_SDA_PIN; // 4
static const uint I2C_SCL_PIN = PICO_DEFAULT_I2C_SCL_PIN; // 5
...
static void send_address() {
    ...
    printf("Actual baudrate of line: %d", baud);

    printf("Queen: Sending this module's address %#04X to the central hub at %#04X\n", MODULE_I2C_ADDRESS, HUB_I2C_ADDRESS);


    int success = i2c_write_timeout_us(i2c0, HUB_I2C_ADDRESS, &MODULE_I2C_ADDRESS, sizeof(MODULE_I2C_ADDRESS), false, 100000);
    while(success == PICO_ERROR_GENERIC || success == PICO_ERROR_TIMEOUT) {
        printf("Queen: Could not send to central hub... trying again\n");
        success = i2c_write_timeout_us(i2c0, HUB_I2C_ADDRESS, &MODULE_I2C_ADDRESS, sizeof(MODULE_I2C_ADDRESS), false, 100000);
    }
    //int success = i2c_write_blocking(i2c1, HUB_I2C_ADDRESS, &MODULE_I2C_ADDRESS, 1, false);
    printf("Queen: Sent address to the central hub\n\n");
